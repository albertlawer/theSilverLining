...
class SystemConfigsControllerTest < ActionController::TestCase
  ...
  test "should create system_config" do
    assert_difference('SystemConfig.count') do
      post :create, system_config: { desc: @system_config.desc, name: @system_config.name, status: @system_config.status, value: @system_config.value }
    end
  ...
  test "should update system_config" do
    patch :update, id: @system_config, system_config: { desc: @system_config.desc, name: @system_config.name, status: @system_config.status, value: @system_config.value }
    assert_redirected_to system_config_path(assigns(:system_config))
  end
